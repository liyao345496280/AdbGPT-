...
def scroll(direction):
    ...
    time.sleep(0.5)
    if direction == "down":
        cmd = "adb shell input swipe {} {} {} {} {}".format(str(config.XML_SCREEN_WIDTH / 2), str(config.XML_SCREEN_HEIGHT - 300), str(config.XML_SCREEN_WIDTH / 2 + 1), str(100), 1500)
    else:
        cmd = "adb shell input swipe {} {} {} {} {}".format(str(config.XML_SCREEN_WIDTH / 2), str(config.XML_SCREEN_HEIGHT * 1 / 16 + 300), str(config.XML_SCREEN_WIDTH / 2 + 1), str(config.XML_SCREEN_HEIGHT - 300), 1500)
    print("run command: {}".format(cmd))
    os.system(cmd)
