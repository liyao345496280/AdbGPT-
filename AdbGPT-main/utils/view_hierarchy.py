...
def _build_object_type(android_class):
  ...
  if android_class.startswith('android.widget'):
    widget_type = android_class.split('.')[2].upper()
...
class LeafNode(object):
  ...
  def __init__(self,
    ...
    bbox = _build_bounding_box(element.get('bounds')) ##PS:4
    self.uiobject = UIObject(
        ...
        visible=strtobool(element.get('visible-to-user', default='true')),
...
class ViewHierarchy(object):
  ...
  def _get_visible_leaves(self):
    ...
    all_visible_leaves = [
        ...
        strtobool(element.get('visible-to-user', default='true')) and
